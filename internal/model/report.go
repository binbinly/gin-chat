...
type ReportModel struct {
	PriID
	UID
	TargetID   int    `gorm:"column:target_id;not null;type:int;index;comment:目标id" json:"target_id"`
	...
	Category   string `gorm:"column:category;not null;size:255;default:'';comment:分类" json:"category"`
